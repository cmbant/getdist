...
html_static_path = ["../getdist_docs_combined.md"]
...
latex_documents = [
    (master_doc, "GetDist.tex", "GetDist Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "GetDist", "GetDist Documentation", [author], 1)]
