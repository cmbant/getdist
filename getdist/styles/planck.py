...
class PlanckPlotter(plots.GetDistPlotter):
    ...
    def get_single_plotter(cls, **kwargs):
        ...
        return super().get_single_plotter(
            scaling=scaling if scaling is not None else False, rc_sizes=True, width_inch=width_inch, **kwargs
        )
    ...
    def get_subplot_plotter(cls, **kwargs):
        scaling = kwargs.pop("scaling", None)
        kwargs.pop("rc_sizes", None)
        return super().get_subplot_plotter(scaling=scaling if scaling is not None else False, rc_sizes=True, **kwargs)
